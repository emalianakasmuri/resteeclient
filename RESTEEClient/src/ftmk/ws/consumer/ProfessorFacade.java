...
public class ProfessorFacade {
	...
	public List<Professor> searchProfessors(String param) throws JSONException, JsonProcessingException {
		...
		List<Professor> results = mapper.readValue(jsonResponse, new TypeReference<List<Professor>>() { });
	...
	public int countProfessors () throws JSONException {
		...
		int numberOfTeachers = Integer.parseInt(response.readEntity(String.class));
